...
> Application answers from Stephen Behunin for Forward Deployed Operator.

<details markdown="1">
<summary>Semantle Strategy</summary>

**Link:** [https://semantle.com/](https://semantle.com/)

**Summary:** Find the secret word using the similarity and rankings scores to guide your guesses.
...
- Guesses generate a raw similarity score
  - Can be positive or negative, high positive is better.
  - The similarity score of a few milestone words is indicated, closest, 10th closest and 1000th closest usually.
- Top 1000 closest words generate a rank 1/1000 is the 999th closest word, 999/1000 is the closest word beside the secret word. All other words generate hot, cold, warm etc.
...
- If you guess a word again after you already guessed it the word will not count against the total number of guesses.
...
1. Place a variety of guesses (3-10) to find a good starting point. If you hit something with a rank (the rank #/1000 appears) or above 15 in similarity stop and move to the next step,
2. Find words that are adjacent to the highest similarity word and chase those words in meaning groupings.
   - Meaning grouping in this case is a set of related words
     - {bat, baseball, glove, pitcher}
     - {cat, toy, pet}
     - {run, exercise, train}
   - Also try levels of specificity:
     - ball → baseball → sport,
     - player → team → league
     - iron → metal → material
3. When stuck find the most similar known words and try one of the following tactics:
   - **Move laterally**, find words in the same meaning group that are farther than your previous guesses. If the most similar word is currently 'pill' and 'pharmacy' didn't improve the score a good lateral move might be 'hospital'. If its currently 'flag' something like 'Anthem' related but a leap away.
...
First the series is broad in it's scope while having specific and memorable characters. The dungeon theme with different levels and complex backstory allow for the same characters to appear naturally in a nearly infinite number of situations while maintaining a coherent story line. This also allows a scale of action and stakes that other books can't achieve within a single limited world. But still allows for emotional investment in and familiarity with the main cast.

Second the creativity is off the charts. A cat name Princess Donut the Queen Anne Chonk that shoots lasers out of its eyes through power enhancing sunglasses while riding a velociraptor is not something I could come up with, ever. And this level of creativity is present in every single book without fail, the material is boundless and Dinniman (author) does things with it I don't see coming seemingly every time. Creativity this insane couples with the open world to make every book unique and interesting.

Finally the writing is funny while having deep themes and connections between the books. Chekov's guns and callbacks are everywhere. Themes stay persistent and are reinforced in poignant moments amid the gore, hilarious imagery and utter absurdity. Character arcs and story throughlines are both baked into the structure of the world and carefully used for real moments of connection with the characters. I think how funny the situations are allow the author to get away with absurdity and deep meaning in shockingly close proximity to each other. And in ways that wouldn't play with any other type of story.
